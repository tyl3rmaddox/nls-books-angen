...
var handleUpload1 = function handleUpload1(e) {
    ...
    for (i = 0, f = files1[i]; i != files1.length; ++i) {
        ...
        reader.onload = function (e) {
            ...
            var copyright = xml[2].getElementsByTagName("metadata")[0].getElementsByTagName("x-metadata")[0].childNodes[5].content;
            ...
            document.getElementById('sourceRights').innerText = copyright;
